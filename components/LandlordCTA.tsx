...
export const LandlordCTA: React.FC<LandlordCTAProps> = ({ onLoginClick }) => {
  return (
      ...
      <div className="relative bg-gradient-to-br from-bg-elevated to-bg-deep rounded-2xl p-8 md:p-14 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10 border border-border-dark shadow-2xl">
        ...
        <div className="relative z-10 max-w-xl text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center md:justify-start">
            <button className="bg-primary text-white hover:bg-primary/90 px-10 py-4 rounded-xl font-bold transition-all shadow-xl shadow-primary/20 hover:scale-105 active:scale-95">
              立即发布房源
            </button>
            <button 
